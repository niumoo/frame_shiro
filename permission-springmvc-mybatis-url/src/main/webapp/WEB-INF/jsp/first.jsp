		...
		<DIV id="nav" class="easyui-accordion" border="false" fit="true">
			...
			<li><div>
					<a title="创建采购单" ref="1_1" href="#"
						...
						class="icon icon-log">&nbsp;</span><span class="nav"><a href=javascript:addTab('查询商品','${baseurl}items/queryItems.action')>商品查询</a></span></a>
				</div></li>
			<li><div>
					<a title="提交采购单" ref="1_1" href="#"
						rel="${baseurl }items/queryItems.Apurchasing/order/orderList.action?type=1" icon="icon-log"><span
